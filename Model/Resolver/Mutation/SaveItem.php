 ...
 */
class SaveItem extends AbstractSaveCartCustomer
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        if (!isset($args['item_id'])) {
            throw new GraphQlInputException(__('"item_id" value should be specified'));
        }
        ...
        return $this->saveProductRepository->save((int)$customer->getId(), $args['cart_id'], $args['item_id']);
    }
}
